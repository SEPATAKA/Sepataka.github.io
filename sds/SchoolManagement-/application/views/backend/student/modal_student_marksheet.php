...
<div class="panel-group joined" id="accordion-test-2">
	...
	$toggle = true;
	$quizs	=	$this->crud_model->get_quizs();
	foreach($quizs as $row0):
    ...
    <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <a data-toggle="collapse" data-parent="#accordion-test-2" href="#collapse<?php echo $row0['quiz_id'];?>">
        ...
        <div id="collapse<?php echo $row0['quiz_id'];?>" class="panel-collapse collapse <?php if($toggle){echo 'in';$toggle=false;}?>" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                //obtained marks
                                $verify_data	=	array(	'quiz_id' => $row0['quiz_id'] ,
