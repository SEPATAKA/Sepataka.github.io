		...
		<div class="tab-content">
                ...
                <table class="table table-bordered table-hover table-striped datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php echo $this->crud_model->get_type_name_by_id('tutor',$row['tutor_id']);?></td>
							<td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?tutor/subject/delete/<?php echo $row['subject_id'];?>/<?php echo $class_id;?>');">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?tutor/subject/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('tutor');?></label>
                                <div class="col-sm-5">
                                    <select name="tutor_id" class="form-control" style="width:100%;">
										...
										?>
                                    		<option value="<?php echo $row['tutor_id'];?>"><?php echo $row['name'];?></option>
                                        <?php
										endforeach;
										?>
                                    </select>
