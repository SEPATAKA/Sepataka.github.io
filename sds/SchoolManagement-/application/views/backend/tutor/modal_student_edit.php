	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?tutor/student/'.$row['class_id'].'/do_update/'.$row['student_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<script type="text/javascript">
	...
	function get_class_sections(class_id) {
    	...
    	$.ajax({
            url: '<?php echo base_url();?>index.php?tutor/get_class_section/' + class_id ,
