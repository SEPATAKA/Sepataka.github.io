	...
	<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
		...
		<tbody>
        	<form method="post" action="<?php echo base_url();?>index.php?tutor/attendance_selector" class="form">
            	<tr class="gradeA">
                    <td>
    ...
    <div class="row">
        <div class="col-sm-offset-4 col-sm-4">
            ...
            <div class="tile-stats tile-white-gray">
                ...
                <h3>Attendance of student <?php echo ($student_id);?></h3>
			...
			foreach($students as $row)
			{
				...
				<tr class="gradeA">
					...
					<td align="center">
                        ...
                        <form method="post" action="<?php echo base_url();?>index.php?tutor/manage_attendance/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>">
