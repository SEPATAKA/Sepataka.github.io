<div class="sidebar-menu">
    <header class="logo-env" >
        ...
        <div class="logo" style="">
            <a href="<?php echo base_url(); ?>">
                <img src="uploads/pc3.png"  style="max-height:60px;"/>
            </a>
        </div>
    ...
    <ul id="main-menu" class="">
        ...
        <!-- DASHBOARD -->
        <li class="<?php if ($page_name == 'dahboard') echo 'active'; ?> ">
                        ...
                        foreach ($classes as $row):
                            ...
                            <li class="<?php if ($page_name == 'student_information' && $class_id == $row['class_id']) echo 'active'; ?>">
                                <a href="<?php echo base_url(); ?>index.php?admin/student_information/<?php echo $row['class_id']; ?>">
                                    <span><?php echo ('Class'); ?> <?php echo $row['student no']; ?></span>
                                </a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
        ...
        <!-- tutor -->
        <li class="<?php if ($page_name == 'tutor') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/tutor">
                <i class="entypo-users"></i>
                <span><?php echo ('tutor Section'); ?></span>
            </a>
        </li>
        ...
        if ($page_name == 'quiz' ||
                $page_name == 'grade' ||
                $page_name == 'marks' ||
                    $page_name == 'quiz_marks_sms')
                        echo 'opened active';
        ?> ">
            <a href="#">
                <i class="entypo-graduation-cap"></i>
                <span><?php echo ('Quiz Section'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'quiz') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/quiz">
                        <span><i class="entypo-dot"></i> <?php echo ('Quiz List'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'grade') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/grade">
                        <span><i class="entypo-dot"></i> <?php echo ('Quiz Grades'); ?></span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'quiz_marks_sms') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/quiz_marks_sms">
