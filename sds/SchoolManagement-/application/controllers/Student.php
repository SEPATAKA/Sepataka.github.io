...
class Student extends CI_Controller
{
    ...
    /****MANAGE tutorS*****/
    function tutor_list($param1 = '', $param2 = '', $param3 = '')
    {
        if ($this->session->userdata('student_login') != 1)
            redirect(base_url(), 'refresh');
        ...
        $page_data['page_title'] = get_phrase('manage_tutor');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function subject($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('supported_subject');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function marks($quiz_id = '', $class_id = '', $subject_id = '')
    {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['quiz_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0) {
                redirect(base_url() . 'index.php?student/marks/' . $page_data['quiz_id'] . '/' . $page_data['class_id'] . '/' . $page_data['subject_id'], 'refresh');
            } else {
